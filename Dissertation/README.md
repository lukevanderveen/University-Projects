...
This Project is an experiment on the works of [Zhang et al (2022)](An_Interpretable_Deep_Semantic_Segmentation_Method_for_Earth_Observation.pdf), which can be found within this repo.
...
For a more indepth description of the project and its processes please refer to my [Dissertation Report](Dissertation%20Report.pdf). 
