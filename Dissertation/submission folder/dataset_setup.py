...
def get_transformations(data_config) -> Tuple[Callable, Callable]:
    ...
    if data_config.test_transformation.normalize:
        ...
        """#this is added, if uh oh, removez
        # **Explicitly apply resizing to test transformations**
        if "resize" in data_config.test_transformation:
            test_transform.append(transformations.ResizeFactor(downsampling_factor=1))"""
