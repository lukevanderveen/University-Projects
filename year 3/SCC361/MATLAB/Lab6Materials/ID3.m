...
for i=1:numberAttributes
    if (activeAttributes(i)) % this one is still active, update its gain
        ...
        %% add your code here for calculating information gain for each attribute
        weightedEntropy = (s1 / numberExamples) * entropy_s1 + (s0 / numberExamples) * entropy_s0;
        gains(i) = currentEntropy - weightedEntropy;
    end
end
%%
