...
private static Scanner scanner = new Scanner(System.in);
  ...
  private static void sellItem(Auction auction, int userId) {
    try {
        ...
        System.out.println("1. Sell an a pre-existing auction");
        System.out.println("2. Sell on a new auction");
        System.out.println("3: Close an Auction");
        int choice = scanner.nextInt();
        //scanner.nextLine();
        AuctionSaleItem item = new AuctionSaleItem();
        switch (choice) {
          case 1: //auction should already exist
            System.out.println("line 84: selling case 1");
            ...
            //System.out.println(item.name + item.description + item.reservePrice);
            break;
          case 2: // create a new auction
            System.out.println("line 93: selling case 2");
            scanner.nextLine(); // clear scanner
            ...
            break;
          case 3:
            System.out.println("line 105: selling case 3");
            scanner.nextLine(); // clear scanner
            System.out.println("Enter auction ID to close: ");
            int auctionIdToClose = scanner.nextInt();
            System.out.println("Attempting to call closeAuction with auctionId: " + auctionIdToClose);  
            try{
              AuctionResult result = auction.closeAuction(userId, auctionIdToClose);
              if (result != null) {
        ...
        return;
          ...
          //server connection
            ...
            while (true) {
              ...
              switch (choice) {
                case 1: // sell item
                  System.out.println("line 148: starting case 1");
                  sellItem(auction, user);
                  break;
                case 2: //buy item
                  System.out.println("line 152: starting case 1");
